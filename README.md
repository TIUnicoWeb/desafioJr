...
## Entrega
>Criar e subir para o reposítorio(https://github.com/TIUnicoWeb/desafioJr.git) uma branch com seu nome com o código desenvolvido para resolver o problema e scripts para criação da estrutura do banco de dados.
>Também é possível enviar a sua prova via email para guilherme.chaves@grupounico.com com o título [Teste Estágio DEV JR] e seu nome.
